...
public class brasileiro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = (WebView) findViewById(R.id.webview_brasileiro);
        ...
        IUnityBannerListener iUnityBannerListener= new IUnityBannerListener() {
            ...
            public void onUnityBannerLoaded(String placementId, View view) {
                ...
                UnityBanners.loadBanner(brasileiro.this, BANNER_ID);
        ...
        if (networkInfo == null || !networkInfo.isConnected() || !networkInfo.isAvailable()) {
            ...
            //load url
            webView.loadUrl("https://onefootball.com/pt-br/competicao/brasileirao-serie-a-16/tabela");
        }
    }}
