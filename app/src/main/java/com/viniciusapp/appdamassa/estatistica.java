...
public class estatistica extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //WebView
        webView = (WebView) findViewById(R.id.webviewestatistica);
        ...
        IUnityBannerListener iUnityBannerListener= new IUnityBannerListener() {
            ...
            public void onUnityBannerLoaded(String placementId, View view) {
                ...
                UnityBanners.loadBanner(estatistica.this, BANNER_ID);
            }
        ...
        if (networkInfo == null || !networkInfo.isConnected() || !networkInfo.isAvailable()) {
            ...
            //load url
            webView.loadUrl("https://appdamassa.vpshostingnow.com.br/estatisticas/");
        }
    }
}
