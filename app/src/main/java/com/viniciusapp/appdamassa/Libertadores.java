...
public class Libertadores extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = (WebView) findViewById(R.id.webview_libertadores);
...
//Inicialize Unity
        ...
        IUnityBannerListener iUnityBannerListener= new IUnityBannerListener() {
            ...
            public void onUnityBannerLoaded(String placementId, View view) {
                ...
                UnityBanners.loadBanner(Libertadores.this, BANNER_ID);
        ...
        if (networkInfo == null || !networkInfo.isConnected() || !networkInfo.isAvailable()) {
            ...
            UnityBanners.loadBanner(Libertadores.this, BANNER_ID);
            //load url
            webView.loadUrl("https://onefootball.com/pt-br/competicao/conmebol-libertadores-da-america-76/tabela");
        }
    }
