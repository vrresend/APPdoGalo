...
public class links extends AppCompatActivity  implements myadapterer.RecyclerItemClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            switch (requestCode) {
                case PERMISSIONS_STORAGE_CODE:
                    if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                        ...
                        AlertDialog.Builder alerta = new AlertDialog.Builder(links.this);
        ...
        public void itemClick (model item){
            ...
            Toast.makeText(links.this, "Testado com sucesso " + link, Toast.LENGTH_LONG).show();
...
*/
        ...
        private void mostrainterticial () {
            if (UnityAds.isReady(INTERSTITIAL_ID)) {
                UnityAds.show(links.this, INTERSTITIAL_ID);
        ...
        private void aumentapontos () {
            ...
            ref.update(hashMap).addOnSuccessListener(new OnSuccessListener() {
                ...
                public void onSuccess(Object o) {
                    Toast.makeText(links.this, "Ganhaste 12 pontos", Toast.LENGTH_SHORT).show();
                }
