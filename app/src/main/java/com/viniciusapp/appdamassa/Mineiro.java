...
public class Mineiro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mineiro);
        ...
        webView = (WebView) findViewById(R.id.webview_mineiro);
...
//Inicialize Unity
        ...
        if (networkInfo == null || !networkInfo.isConnected() || !networkInfo.isAvailable()) {
            UnityBanners.loadBanner(Mineiro.this, BANNER_ID);
            ...
            //load url
            webView.loadUrl("https://onefootball.com/pt-br/competicao/campeonato-mineiro-198/tabela");
        }
    }
}